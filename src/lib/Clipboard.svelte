...
<button on:click={handleClick} class="flex items-center gap-1 rounded-md bg-cool-gray-100 hover:bg-cool-gray-200 dark:bg-cool-gray-800 dark:hover:bg-cool-gray-700 dark:hover:bg-opacity-70 transition-all p-2 text-lg h-10 active:scale-95 ease-out duration-100">
  {#if state == 0}
